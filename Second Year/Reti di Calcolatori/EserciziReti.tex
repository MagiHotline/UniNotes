...
\[SEG = 1 + 2 + 4 + 8 + 8 + 9 + 10 + 11 + \cancel{12} + 1 + 2 + 4 + \cancel{6} + 1 + \overbrace{\cancel{2}}^{1} = 62 \]
\[CWND_{finale} = CWND_{old} + \# ACK = 3\]

\subsection{ Esercizio 2 02/07/2020}

Tre lan con i seguenti vincoli sul numero di host:
