...
public class IntExpLexer extends Lexer {
	...
	public static final int
		VAR=1, LPAR=2, RPAR=3, ADD=4, MUL=5, SUB=6, INT=7, DIV=8, MOD=9, EQUALS=10, 
		SEMICOLON=11, WS=12;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"VAR", "LPAR", "RPAR", "ADD", "MUL", "SUB", "INT", "DIV", "MOD", "EQUALS", 
			"SEMICOLON", "WS"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "VAR", "LPAR", "RPAR", "ADD", "MUL", "SUB", "INT", "DIV", "MOD", 
			"EQUALS", "SEMICOLON", "WS"
		};
	}
