...
public class AmbiguousParser extends Parser {
	...
	public static final int
		T__0=1, FOR=2, EACH=3, FOREACH=4, VAR=5, ID=6;
	public static final int
		RULE_main = 0;
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, "FOR", "EACH", "FOREACH", "VAR", "ID"
		};
	}
	...
	public static class MainContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AmbiguousListener ) ((AmbiguousListener)listener).enterMain(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AmbiguousListener ) ((AmbiguousListener)listener).exitMain(this);
		}
		@Override
