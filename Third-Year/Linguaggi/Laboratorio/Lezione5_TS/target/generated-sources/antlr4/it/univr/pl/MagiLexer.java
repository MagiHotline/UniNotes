...
public class MagiLexer extends Lexer {
	...
	public static final int
		...
		SEMICOLON=29, STRING=30, VAR=31, WS=32, COMMENT=33, LINE_COMMENT=34;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LPAR", "RPAR", "LCUR", "RCUR", "IF", "ELSE", "WHILE", "PRINT", "CONCAT", 
			"FLOAT", "INT", "ADD", "MUL", "SUB", "DIV", "MOD", "POW", "TYPE", "BOOL", 
			"NOT", "EQ", "NEQ", "LT", "GT", "LTE", "GTE", "AND", "OR", "ASSIGN", 
			"SEMICOLON", "STRING", "STRCHAR", "ESC", "VAR", "WS", "COMMENT", "LINE_COMMENT"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"SEMICOLON", "STRING", "VAR", "WS", "COMMENT", "LINE_COMMENT"
		};
	}
