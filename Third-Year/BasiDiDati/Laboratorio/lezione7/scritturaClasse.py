...
class Spese:
    """
    L'attributo 'tabella' reppresenta le spese organizzate come dict( primaryKey, riga ).
    ...
    """
    @staticmethod # Per evitare di inserire self ogni santa volta ^ opzionalmente si può inserire fuori da questa classe del cazzo
    ...
    def get(self, data, voce):
        return self.tabella[Spese.makeKey(data, voce)]
